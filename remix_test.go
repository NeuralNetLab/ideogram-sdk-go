...
func TestRemixNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Remix.New(context.TODO(), ideogramsdk.RemixNewParams{
		ImageFile: io.Reader(bytes.NewBuffer([]byte("some file contents"))),
		ImageRequest: ideogramsdk.RemixNewParamsImageRequest{
			ImageRequestParam: ideogramsdk.ImageRequestParam{
